...
:---------------------|:---------------------|:---------------------|
[Анализ статистики и отчет о проведенном PoC для клиента телеком компании](https://github.com/maryaborisova/portfolio/tree/main/report_for_telecom) | Анализ и визуализация PoC услуги определения голосовой почты для кейса soft-collection (обзвон для взыскания долгов) | Excel
