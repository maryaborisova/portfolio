# Построение дашборда о ситуации на рынке колбас и колбасной продукции. 
...
## Результат:
Я подготовила интерактивный дашборд в программе Power BI согласно цели, требованиям и задачам проекта.
